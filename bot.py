...
TEXTS = {
    "kh": {
        ...
        "loc_found": "✅ ចាប់បានទីតាំង៖ **{}, {}**\n\n✍️ សូមសរសេរជីវប្រវត្តិខ្លីៗពីខ្លួនអ្នក (ឧ. ចូលចិត្តស្តាប់ចម្រៀង...):",
        "ask_photo": "📸 ជិតរួចរាល់ហើយ! សូមផ្ញើរូបថតរបស់អ្នកមួយសន្លឹកមក:",
        "loc_err": "❌ មិនអាចចាប់ទីតាំងបានទេ។ សូមវាយឈ្មោះទីក្រុងជាអក្សរមកវិញ។",
        ...
        "chat_him": "💬 ឆាតរកគាត់ផ្ទាល់",
        "chat_back": "💬 ផ្ញើសារទៅគាត់វិញ",
        "match_notif": "🎉 Match ថ្មី! មនុស្សដែលអ្នកបាន Like ទើបតែ Like អ្នកវិញហើយ! កុំឱ្យឱកាសកន្លងផុតទៅ!",
...
# ==========================================
# 🌐 LANGUAGE / ⚙️ PREFERENCES / 👤 PROFILE / 🔍 MATCH
# ==========================================
